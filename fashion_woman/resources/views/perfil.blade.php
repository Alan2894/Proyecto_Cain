        ...
        <div class="card profile-card">
            ...
            <div class="card-body">
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-md-9">
                        <h5 class="mb-1">{{ session('usuario')['nombre'] ?? 'Usuario' }}</h5>
                ...
                <div class="mb-4">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">1-555-555-555</div>
                    </div>
                    <div class="row mb-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">Calle Los Pinos #143, Colonia El Mirador, C.P. 57000, Nezahualcóyotl, Estado de México</div>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Orden
                            <span class="badge bg-primary rounded-pill">Fecha</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
...
<div class="modal fade" id="confirmDelete" tabindex="-1" aria-hidden="true" data-bs-backdrop="false">
